...
;CLASS
 ...
 : PickUpWord { \ sstr  mlen len  -- }  \  выделить одно первое слово из строчки
 0 -> len  -> mlen ->  sstr
...
: ERR-INCLUDE-PROBE
 ...
 ELSE 2DROP S" "  THEN  
  2DUP ?STR_FILE    IF INCLUDE-PROBE DROP 0 ELSE  1 THEN \ добавить контроль ошибок!
;
...
: a
" 1" 0 NSPUW STR@ str>num . . CR
" 1 " 0 NSPUW STR@  str>num . . CR
" 12" 0 NSPUW STR@ str>num . . CR
" 12 " 0 NSPUW STR@ str>num . . CR
...
" 1" S>FLOAT  F. DROP CR
" 4 " S>FLOAT  F. DROP CR
 " 56" S>FLOAT  F. DROP CR
 " .e" S>FLOAT  F. DROP CR
 " e" S>FLOAT  F. DROP CR
 " ." S>FLOAT  F. DROP CR
" 1.23" S>FLOAT  F. DROP CR
" 123" S>FLOAT  F. DROP CR
" 123e" S>FLOAT  F. DROP CR
" 123." S>FLOAT  F. DROP CR
" 321.e" S>FLOAT  F. DROP CR
" 1.23e2" S>FLOAT  F. DROP   CR
" 123456789123456" S>FLOAT  F. DROP   CR
...
: z
 " 1" 0 NSPUW  " |" STYPE  STYPE  " |" STYPE CR
 " 1234" 0 NSPUW  " |" STYPE  STYPE  " |" STYPE CR
 "  1234" 0 NSPUW " |" STYPE  STYPE  " |" STYPE CR
 " 1234 " 0 NSPUW " |" STYPE  STYPE " |" STYPE CR
 "  1234 " 0 NSPUW " |" STYPE  STYPE  " |" STYPE CR

 " 1234  789" 1 NSPUW " |" STYPE  STYPE  " |" STYPE CR
 "  1234  789" 1 NSPUW " |" STYPE  STYPE  " |" STYPE CR
 " 1234  789 " 1 NSPUW " |" STYPE  STYPE  " |" STYPE CR
 "  1234  789 " 1 NSPUW " |" STYPE  STYPE  " |" STYPE CR

 " 1234  789" 0 NSPUW " |" STYPE  STYPE  " |" STYPE CR
 "  1234  789" 0 NSPUW " |" STYPE  STYPE  " |" STYPE CR
 " 1234  789 " 0 NSPUW " |" STYPE  STYPE  " |" STYPE CR
 "  1234  789 " 0 NSPUW " |" STYPE  STYPE  " |" STYPE CR
